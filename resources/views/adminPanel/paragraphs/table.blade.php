        ...
        <tr>
            ...
            <td nowrap>
                ...
                <div class='btn btn-sm-group'>
                    @can('paragraphs view')
                    <a href="{{ route('adminPanel.paragraphs.show', [$paragraph->id]) }}" class='btn btn-sm btn-success'><i class="fa fa-eye"></i></a>
                    @endcan
                    @can('paragraphs edit')
                    <a href="{{ route('adminPanel.paragraphs.edit', [$paragraph->id]) }}" class='btn btn-sm btn-primary'><i class="fa fa-edit"></i></a>
                    @endcan
