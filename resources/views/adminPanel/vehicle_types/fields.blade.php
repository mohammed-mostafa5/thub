        ...
        <div class="tab-content mt-5" id="myTabContent">
            ...
            <div class="tab-pane fade {{request()->filled('lang')? request('lang') == $name ?'show active':'' : $i?'show active':''}}" id="{{$name}}" role="tabpanel" aria-labelledby="{{$name}}-tab">
                ...
                <div class="form-group col-sm-12">
                    {!! Form::label('text', __('models/vehicleTypes.fields.text').':') !!}
                    {!! Form::text($locale . '[text]', isset($vehicleType)? $vehicleType->translateOrNew($locale)->text : '' ,
                    ['class' =>
            ...
            <div class="form-group col-sm-12">
                ...
                <a href="{{ route('adminPanel.vehicleTypes.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
            </div>
