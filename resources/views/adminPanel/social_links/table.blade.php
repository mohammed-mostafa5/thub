        ...
        <tr>
            ...
            <td nowrap>
                ...
                <div class='btn btn-sm-group'>
                    ...
                    <a href="{{ route('adminPanel.socialLinks.show', [$socialLink->id]) }}" class='btn btn-sm btn-success'><i class="fa fa-eye"></i></a>
                    @endcan
                    @can('socialLinks edit')

                    <a href="{{ route('adminPanel.socialLinks.edit', [$socialLink->id]) }}" class='btn btn-sm btn-primary'><i class="fa fa-edit"></i></a>
                    @endcan
