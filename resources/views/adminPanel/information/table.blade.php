        ...
        <tr>
            ...
            <td nowrap>
                ...
                <div class='btn btn-sm-group'>
                    ...
                    <a href="{{ route('adminPanel.information.show', [$info->id]) }}" class='btn btn-sm btn-success'><i class="fa fa-eye"></i></a>
                    @endcan
                    @can('information edit')
                    <a href="{{ route('adminPanel.information.edit', [$info->id]) . "?languages=". \App::getLocale() }}" class='btn btn-sm btn-primary'><i class="fa fa-edit"></i></a>
                    @endcan
