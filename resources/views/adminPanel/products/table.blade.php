...
<table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
    <thead>
        ...
        <th>@lang('models/products.fields.old_price')</th>
        ...
        @foreach($products as $product)
            ...
            <td>{{ $product->status }}</td>
                <td nowrap>
                    ...
                    @endcan
                    @can('products edit')
                        <a href="{{ route('adminPanel.products.edit', [$product->id]) }}" class='btn btn-sm btn-shadow mx-1 btn-transparent-primary'><i class="fa fa-edit"></i></a>
                    @endcan
