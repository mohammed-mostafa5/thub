...
<li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu "><i class="menu-arrow"></i>
        <ul class="menu-subnav">
            ...
            @can('drivers view')
            <li class="menu-item  {{ Request::is('*drivers*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.drivers.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/drivers.plural')</span>
                </a>
            </li>
            @endcan
            ...
            <li class="menu-item  {{ Request::is('*customers*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.customers.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/customers.plural')</span>
                </a>
            </li>
            @endcan
...
<li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu "><i class="menu-arrow"></i>
        <ul class="menu-subnav">
            ...
            @can('services view')
            <li class="menu-item  {{ Request::is('*services*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.services.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/services.plural')</span>
                </a>
            </li>
            @endcan
            ...
            @can('appFeatures view')
            <li class="menu-item  {{ Request::is('*appFeatures*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.appFeatures.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/appFeatures.plural')</span>
                </a>
            </li>
            @endcan
...
<li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu "><i class="menu-arrow"></i>
        <ul class="menu-subnav">
            @can('vehicles view')
            <li class="menu-item  {{ Request::is('*vehicles*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.vehicles.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/vehicles.plural')</span>
                </a>
            </li>
            @endcan

            @can('brands view')
            <li class="menu-item  {{ Request::is('*brands*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.brands.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/brands.plural')</span>
                </a>
            </li>
            @endcan

            @can('vehicleTypes view')
            <li class="menu-item  {{ Request::is('*vehicleTypes*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.vehicleTypes.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/vehicleTypes.plural')</span>
                </a>
            </li>
            @endcan

            @can('colors view')
            <li class="menu-item  {{ Request::is('*colors*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.colors.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/colors.plural')</span>
                </a>
            </li>
            @endcan
...
<li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu "><i class="menu-arrow"></i>
        <ul class="menu-subnav">
            ...
            @can('trips view')
            <li class="menu-item  {{ Request::is('*trips*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                <a href="{{ route('adminPanel.trips.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/trips.plural')</span>
                </a>
            </li>
            @endcan
...
@can('rewards view')
<li class="menu-item  {{ Request::is('*rewards*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
    <a href="{{ route('adminPanel.rewards.index') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">@lang('models/rewards.plural')</span>
    </a>
</li>
@endcan
...
<li class="menu-item  {{ Request::is('adminPanel/reasons*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.reasons.index') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">@lang('models/reasons.plural')</span>
    </a>
</li>


<li class="menu-item  {{ Request::is('adminPanel/categories*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.categories.index') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">@lang('models/categories.plural')</span>
    </a>
</li>
