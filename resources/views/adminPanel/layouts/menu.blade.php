...
<li class="menu-item  {{ Request::is('adminPanel/states*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.states.index') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">@lang('models/states.plural')</span>
    </a>
</li>

<li class="menu-item  {{ Request::is('adminPanel/donationTypes*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.donationTypes.index') }}" class="menu-link ">
        <span class="svg-icon menu-icon">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">@lang('models/donationTypes.plural')</span>
    </a>
</li>
