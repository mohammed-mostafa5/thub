        ...
        <tr>
            ...
            <td nowrap>
                ...
                <div class='btn btn-sm-group'>
                    @can('pages view')
                    <a href="{{ route('adminPanel.pages.show', [$page->id]) }}" class='btn btn-sm btn-success'>
                        <i class="fa fa-eye"></i>
                    </a>
                    @endcan
                    @can('pages edit')
                    <a href="{{ route('adminPanel.pages.edit', [$page->id]) . "?languages=$locale" }}" class='btn btn-sm btn-primary'>
