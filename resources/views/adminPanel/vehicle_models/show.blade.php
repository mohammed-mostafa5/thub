                ...
                <div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('adminPanel.brands.vehicleModels.index',$vehicleModel->brand_id) }}" class="btn btn-secondary font-weight-bolder">
                    ...
                    <div class="card-body">
                        @include('adminPanel.vehicle_models.show_fields')
                    </div>
                </div>
                <!--end::Card-->
            </div>
